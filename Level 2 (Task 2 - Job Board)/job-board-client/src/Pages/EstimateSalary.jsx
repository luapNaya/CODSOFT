    ...
    <div className=' max-w-screen-2xl container mx-auto xl:px-24 px-4'>
        ...
        <div className='mt-5'>
            <div className='search-box p-2 text-center mb-2 space-x-1'>
                <input type="text" name="search" id="search" className=' py-2 pl-3 border rounded focus:outline-none lg:w-6/12 mb-4 w-full' onChange={(e) => setSearchText(e.target.value)}/>

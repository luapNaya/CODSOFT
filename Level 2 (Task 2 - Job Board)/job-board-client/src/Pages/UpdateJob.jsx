                ...
                <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
                    ...
                    <div className='create-job-flex'>
                        ...
                        <div className='lg:w-1/2 w-full'>
                            ...
                            <input type="text" placeholder='Eg. Microsoft' defaultValue={companyName}
                    ...
                    <div className='create-job-flex'>
                        ...
                        <div className='lg:w-1/2 w-full'>
                            ...
                            <input type="text" placeholder='Eg. London' defaultValue={jobLocation}
                    ...
                    <div className='create-job-flex'>
                        <div className='lg:w-1/2 w-full'>
                            ...
                            <input type="date" placeholder='Eg. 2024-04-17' defaultValue={postingDate}
                    ...
                    <div className='create-job-flex'>
                        <div className='lg:w-1/2 w-full'>
                            ...
                            <input type="url" placeholder='Paste your image url' defaultValue={companyLogo}
                    ...
                    <div className='w-full'>
                        ...
                        <input type="email" placeholder='your email' defaultValue={postingBy}
